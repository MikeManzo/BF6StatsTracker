#!/bin/bash
# ============================================================
#  BF6StatsTracker — Local Release Script
...
BUNDLE_ID="com.CitizenCoder.BF6StatsTracker"
GITHUB_REPO="MikeManzo/BF6StatsTracker"
RELEASE_BRANCH="main"
SPARKLE_BIN="./bin"
...
if [ -z "$APPLE_ID_PASSWORD" ]; then
  ...
  security add-generic-password -a \"BF6StatsTracker\" -s \"BF6ReleaseScript\" -w \"xxxx-xxxx-xxxx-xxxx\""
fi

# ── Paths ────────────────────────────────────────────────────
WORK_DIR=~/Desktop/BF6Release
